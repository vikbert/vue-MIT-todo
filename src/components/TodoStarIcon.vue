  ...
  export default {
    ...
    computed: {
      classObject: function() {
        return {
          'starred': this.starred == STATUS_STARRED,
          'star': this.starred == STATUS_STAR,
          'starred_completed': this.starred && this.todo.completed,
        };
      },
    },
    methods: {
      toggleStarStatus(todo) {
        ...
        this.starred = todo.starred === STATUS_STARRED ? STATUS_STAR : STATUS_STARRED;
