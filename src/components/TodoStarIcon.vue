<template>
  <span v-if="todo.starred" @click="toggleStarStatus(todo)" class="starred" :class="{starred_completed: todo.completed}">
  ...
  <span v-else @click="toggleStarStatus(todo)" class="star">
